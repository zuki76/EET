...
class MaskedAutoencoderViTAE(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
                 ...
                 mlp_ratio=4., norm_layer=nn.LayerNorm, norm_pix_loss=False, kernel=3, mlp_hidden_dim=None):
        '''
...
def mae_vitae_base_patch16_dec512d8b(**kwargs):
...
def mae_vitae_large_patch16_dec512d8b(**kwargs):
    model = MaskedAutoencoderViTAE(
...
mae_vitae_base_patch16 = mae_vitae_base_patch16_dec512d8b  # decoder: 512 dim, 8 blocks
mae_vitae_large_patch16 = mae_vitae_large_patch16_dec512d8b  # decoder: 512 dim, 8 blocks
