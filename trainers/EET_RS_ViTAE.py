...
from domain_model_rs.code import models_mae_vitae_af
...
def load_clip_to_cpu(cfg):
    ...
    design_details = {"trainer": 'EET_RS_ViTAE',
                      "expert_pos_num": (224 // 16) ** 2 + 1,
                      "vision_depth": 0,
                      "language_depth": 0, "vision_ctx": 0,
                      "language_ctx": 0,
                      "maple_length": cfg.TRAINER.EET_RS_ViTAE.N_CTX}
...
class MultiModalPromptLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        n_ctx = cfg.TRAINER.EET_RS_ViTAE.N_CTX
        ctx_init = cfg.TRAINER.EET_RS_ViTAE.CTX_INIT
        dtype = clip_model.dtype
        ctx_dim = clip_model.ln_final.weight.shape[0]
        clip_imsize = clip_model.visual.input_resolution
        cfg_imsize = cfg.INPUT.SIZE[0]
        # Default is 1, which is compound shallow prompting
        assert cfg.TRAINER.EET_RS_ViTAE.PROMPT_DEPTH >= 1, "For EET_RS_ViTAE, PROMPT_DEPTH should be >= 1"
        self.compound_prompts_depth = cfg.TRAINER.EET_RS_ViTAE.PROMPT_DEPTH  # max=12, but will create 11 such shared prompts
        ...
        print('EET_RS_ViTAE design: Multi-modal Prompt Learning')
        print(f'Initial context: "{prompt_prefix}"')
        print(f"Number of EET_RS_ViTAE context words (tokens): {n_ctx}")
        ...
        # Minimum can be 1, which defaults to shallow EET_RS_ViTAE
        # compound prompts
...
class CustomCLIP(FrozenExpertModel):
    def __init__(self, cfg, classnames, clip_model):
        ...
        self.domain_model = models_mae_vitae_af.__dict__['mae_vitae_base_patch16'](norm_pix_loss=False)
        model_path = cfg.MODEL.EXPERT_CHECKPOINT or 'ROOT_TO_CKPT/vitae-b-checkpoint-1599-transform-no-average.pth'
...
class EET_RS_ViTAE(TrainerX):
    def check_cfg(self, cfg):
        assert cfg.TRAINER.EET_RS_ViTAE.PREC in ["fp16", "fp32", "amp"]
    ...
    def build_model(self):
        ...
        if cfg.TRAINER.EET_RS_ViTAE.PREC == "fp32" or cfg.TRAINER.EET_RS_ViTAE.PREC == "amp":
        ...
        self.scaler = GradScaler() if cfg.TRAINER.EET_RS_ViTAE.PREC == "amp" else None
    ...
    def forward_backward(self, batch):
        ...
        prec = self.cfg.TRAINER.EET_RS_ViTAE.PREC
        if prec == "amp":
            with autocast():
